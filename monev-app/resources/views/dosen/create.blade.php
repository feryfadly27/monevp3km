<x-app-layout>
    <x-slot name="pageTitle">Tambah Dosen</x-slot>
    <x-slot name="pageSubtitle">Daftarkan profil dosen baru</x-slot>
        ...
        <form method="POST" action="{{ route('dosen.store') }}" class="space-y-5">
            ...
            <div class="bg-white border border-slate-200 rounded-[8px] p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}"
                           class="input-field @error('nama') border-red-400 @enderror" required autofocus
                ...
                <div>
                    ...
                    <input type="text" name="nidn" value="{{ old('nidn') }}"
                           class="input-field font-mono @error('nidn') border-red-400 @enderror" required
                           placeholder="Nomor Induk Dosen Nasional" maxlength="20">
            ...
            <div class="bg-white border border-slate-200 rounded-[8px] p-6 space-y-3">
                ...
                <p class="text-slate-400" style="font-size:13px;">
                    Pilih akun user yang akan dihubungkan dengan profil dosen ini agar data login tersambung.
                </p>
                ...
                @if($usersAvailable->isEmpty())
                    <p class="text-amber-600" style="font-size:13px;">Semua akun user sudah terhubung ke profil dosen.</p>
                @endif
            </div>

            <div class="flex items-center gap-3">
                <button type="submit" class="btn-primary">
                    <i class="ti ti-user-plus mr-1"></i> Simpan Dosen
                </button>
